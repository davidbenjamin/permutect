...
def test_read_set_datum():
    ...
    snv_datum = read_set.ReadSet(contig, position, ref, alt, ref_tensor, alt_tensor, gatk_info_tensor, label,
    ...
    insertion_datum = read_set.ReadSet(contig, position, "A", "AC", ref_tensor, alt_tensor, gatk_info_tensor,
    ...
    deletion_datum = read_set.ReadSet(contig, position, "AC", "A", ref_tensor, alt_tensor, gatk_info_tensor, label,
                                            tumor_depth, tumor_alt_count, normal_depth, normal_alt_count)
