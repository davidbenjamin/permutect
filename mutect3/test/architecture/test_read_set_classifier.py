...
def test_wide_and_narrow_gaussian_data():
    ...
    assert training_metrics.metrics.get("TRAIN variant accuracy")[training_params.num_epochs - 1] > 0.93
    assert training_metrics.metrics.get("TRAIN artifact accuracy")[training_params.num_epochs - 1] > 0.93
    assert training_metrics.metrics.get("VALID variant accuracy")[training_params.num_epochs-1] > 0.93
    assert training_metrics.metrics.get("VALID artifact accuracy")[training_params.num_epochs - 1] > 0.93
