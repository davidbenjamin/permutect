...
import "https://api.firecloud.org/ga4gh/v1/tools/davidben:train-permutect/versions/7/plain-WDL/descriptor" as training
...
workflow CallVariantsWithUDA {
    ...
    call training.TrainPermutectModel {
        input:
            train_tar = train_tar,
    ...
    call calling.PermutectFiltering {
        input:
            ...
            permutect_model = TrainPermutectModel.permutect_model,
    ...
    output {
        ...
        File training_tensorboard_tar = TrainPermutectModel.training_tensorboard_tar
