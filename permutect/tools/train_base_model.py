...
def train_base_model(params: BaseModelParameters, training_params: TrainingParameters, learning_method: LearningMethod,
                     optimizer: str, summary_writer: SummaryWriter, dataset: BaseDataset, pretrained_model: BaseModel = None) -> BaseModel:
    ...
    learn_base_model(base_model, dataset, learning_method, optimizer, training_params, summary_writer=summary_writer)
    return base_model
...
def main_without_parsing(args):
    ...
    model = train_base_model(params=params, dataset=dataset, training_params=training_params, learning_method=learning_method,
                             optimizer=optimizer, summary_writer=summary_writer, pretrained_model=pretrained_model)
